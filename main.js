...
(function initCardTilt() {
  /* Targets: skill groups, stats, interests, soft skills, purpose */
  const cards = document.querySelectorAll('.skill-group, .stat-card, .interest-card, .soft-skill-card, .purpose-card');
...
(function initPokerDeck() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: 'Linux Environment Infrastructure',
      desc: 'Automatización y estandarización del entorno de desarrollo personal. Scripts de configuración a bajo nivel para optimización de recursos, personalización de terminal y gestión de ventanas con <strong style="color:var(--text-main)">Hyprland</strong> en Linux.',
  ...
  function showDetail(index) {
    ...
    detail.innerHTML = `
      <div class="poker-detail-card">
        <button class="detail-close" aria-label="Cerrar detalle">Volver a baraja</button>
  ...
  function closeCard() {
    ...
    detail.innerHTML = `
      <p class="poker-hint">
        <span>↑</span> Haz click en una carta para ver el detalle
      </p>
    `;
    updateFan();
  }
